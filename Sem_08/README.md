...
- Проверката за това дали има елемент с даден код и извличането на елемент с даден код трябва да става във време O(log(n)).
- Представянето на данните вътрешно трябва да е с динамичен масив от указатели към обекти.
